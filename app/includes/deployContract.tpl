<main class="tab-pane active" ng-if="globalService.currentTab==globalService.tabs.deployContract.id" ng-controller='deployContractCtrl' ng-cloak>

    <div class="block text-center" ng-show="false">
        <h1>
    ...
    <div class="form-group" ng-show="contractNameShow">
        <h4>合约名称: </h4>
        <input class="form-control" type="text" maxlength="10" ng-model="contractName" ng-class="Validator.isNotEmpty(contractName) ? 'is-valid' : 'is-invalid'">
    </div>
    ...
    <article ng-show="visibility=='deployView'">

        @@if (site === 'mew' ) { @@include( '../includes/alert-modal.tpl', { "site": "mew" } ) }
        @@if (site === 'cx'  ) { @@include( '../includes/alert-modal.tpl', { "site": "cx"  } ) }
