...
<footer class="footer" role="content" aria-label="footer" ng-controller='footerCtrl' >
  ...
  <article class="block__wrap" style="max-width: 1780px; margin: auto;">
    ...
    <section class="footer--cent">
        <h5> <i aria-hidden="true">Ì†ΩÌ±´</i> You can support us by supporting our blockchain-family.</h5>
        ...
        <h5><i aria-hidden="true">Ì†ΩÌ≤ù</i> Donations are always appreciated!</h5>
        ...
        -->
        <h5 ng-hide="curLang=='en'"> <i>Ì†ºÌøÖ</i> <span translate="Translator_Desc"> Thank you to our translators </span></h5>
