...
tx_notFound                 : '交易没有找到',
tx_notFound_1               : '该笔交易在你连接节点的交易池里没有找到。',
tx_notFound_2               : '如果你刚发送此笔交易，请等待15秒再次点击"查询交易状态"按钮。 ',
tx_notFound_3               : '还可以在不同的节点的交易池，等待挖矿。',
tx_notFound_4               : '请使用右上角的下拉框并且选择一个不同的ETH节点 (例如. `ETH (Etherscan.io)` 或者 `ETH (Infura.io)` 或者 `ETH (MyEtherWallet)`) 。',
tx_foundInPending           : '处理中的交易',
tx_foundInPending_1         : '你的交易已经在你连接节点的交易池里。',
tx_foundInPending_2         : '此笔交易正在处理中(等待被挖矿)。',
tx_foundInPending_3         : '你有机会可以取消或者替换此笔交易，在下面打开你的钱包。',
tx_FoundOnChain             : '交易结果',
tx_FoundOnChain_1           : '已在区块链上发现你的交易',
tx_FoundOnChain_2           : '**如果你发现红色的 `( ! )`,  `BAD INSTRUCTION` 或者 `OUT OF GAS`的错误信息**, 这意味着此交易没有成功发送. 你不能取消或者更改次交易. 但是你可以重新发起一笔交易. 如果你收到 "Out of Gas" 这个错误, 你需要加倍gas limit的原始值.',
tx_FoundOnChain_3           : '**如果你没有看见任何的红色错误信息,说明你的交易已经成功发送.** 你的 ETH 或者 Tokens 这在被发送. 如果你没看见 ETH 或者 Tokens 到账, 从你发送交易的24小时之后会看到, 请 [联系服务](https://myetherwallet.groovehq.com/knowledge_base/topics/i-have-a-question-but-its-not-about-myetherwallet-dot-com-what-do-i-do). 向他们发送您的交易链接，并咨询，看看你的情况.',
...
GET_ConfButton              : '我知道了，继续',
GEN_Label_5                 : '保存你的`Private Key`. ',
GEN_Unlock                  : '解锁钱包查看地址',
...
NAV_Contact                 : '联系我们 ',
NAV_Contracts               : '合同 ',
NAV_DeployContract          : '部署多签钱包合约 ',
NAV_ENS                     : 'ENS',
NAV_GenerateWallet_alt      : '新建钱包',
...
NAV_Swap                    : 'Swap ',
NAV_ViewWallet              : '多签钱包信息 ',
NAV_YourWallets             : '你的钱包 ',
NAV_CacheContractAddress   : '本地保存合约地址',
NAV_ExecuteWithContract    : '多签钱包转账',
NAV_ConfirmWithContract:'多签钱包确认交易',
NAV_RevokeWithContract:'多签钱包取消确认',
NAV_QueryOpid:'查询多签转账操作id',
...
ERROR_38                    : '最小签名者数格式错误', // 38
ERROR_39                    : '所有者格式错误', // 39
ERROR_40                    : '交易id无效', // 40
ERROR_41                    : '多签钱包余额不足', // 40
