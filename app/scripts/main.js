...
var viewWalletCtrl2           = require('./controllers/viewWalletCtrl2');
var txStatusCtrl              = require('./controllers/txStatusCtrl');
var queryOpidCtrl              = require('./controllers/queryOpidCtrl');
...
var cacheContractAddressCtrl            = require('./controllers/cacheContractAddressCtrl');
var contractsCtrl            = require('./controllers/contractsCtrl');
var deployContractCtrl       = require('./controllers/deployContractCtrl');
var executeWithContract       = require('./controllers/executeWithContract');
var confirmWithContract       = require('./controllers/confirmWithContract');
var revokeWithContract       = require('./controllers/revokeWithContract');
...
app.controller('viewWalletCtrl', ['$scope', '$sce', 'walletService', viewWalletCtrl]);
app.controller('viewWalletCtrl2', ['$scope', 'walletService', viewWalletCtrl2]);
app.controller('txStatusCtrl', ['$scope', txStatusCtrl]);
app.controller('queryOpidCtrl', ['$scope', queryOpidCtrl]);
...
app.controller('cacheContractAddressCtrl', ['$scope', '$sce', cacheContractAddressCtrl]);
app.controller('executeWithContract', ['$scope', '$sce', 'walletService', executeWithContract]);
app.controller('confirmWithContract', ['$scope', '$sce', 'walletService', confirmWithContract]);
app.controller('revokeWithContract', ['$scope', '$sce', 'walletService', revokeWithContract]);
